  ...
  return (
    <div className="bg-canvas-light rounded-[4px] border-[1px] border-post-border flex mb-[16px] p-[8px]">
      ...
      <Link to={`/profile/${currentAccount.username}`} className="w-[38px] h-[38px] rounded-full mr-[8px] basis-[38px]">
        <Avatar classNames="w-[38px] h-[38px]" src={currentAccount.avatar || defaultAvatar} alt="invesddit logo" />
      </Link>

      {/* Create Text Post Link */}
      <Link to="submit" className="grow flex">
      ...
      <Link to="submit?type=media" className="rounded-[4px] min-h-[40px] min-w-[40px] flex items-center justify-center text-feed-text hover:bg-icon-hover">
      ...
      <Link to="submit?type=link" className="rounded-[4px] min-h-[40px] min-w-[40px] flex items-center justify-center text-feed-text hover:bg-icon-hover">
        <svg className="w-[20px] h-[20px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
