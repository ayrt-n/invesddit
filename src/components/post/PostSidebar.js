...
function PostSidebar({ id, score, voted, updatePostVoteStatus, preview }) {
  ...
  return (
    <div className={`${bgColor} min-w-[40px] flex flex-col items-center py-[8px] rounded-tl-[4px] rounded-bl-[4px]`}>
      ...
      {voted === 'upvote' ?
        <ProtectedButton onClick={deletePostVote} className="flex items-center justify-items-center" aria-label="upvote">
        ...
        <ProtectedButton onClick={upvotePost} className="flex items-center justify-items-center" aria-label="upvote">
      ...
      {voted === 'downvote' ?
        <ProtectedButton onClick={deletePostVote} className="flex items-center justify-items-center" aria-label="downvote">
        ...
        <ProtectedButton onClick={downvotePost} className="flex items-center justify-items-center" aria-label="downvote">
