...
function AboutCommunityWidget({ description, createdAt, membershipCount }) {
  ...
  return (
    <ContentCard className="p-[12px]">
      <h2 className="text-[14px] font-bold leading-[18px] mb-[24px]">
        About Community
      </h2>
      <div className="text-[14px] leading-[21px]">
        {description}
      </div>
      <div className="mt-[12px] text-[14px] leading-18px flex text-meta-text">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-[20px] h-[20px] mr-[8px] align-middle">
        ...
        <span>
          Created {format(createdAtDate, "LLL d, yyyy")}
        </span>
      </div>
