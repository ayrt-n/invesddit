...
import PostTitleInput from './forms/PostTitleInput';
        ...
        <div className="w-[640px]">
          ...
          <div className="bg-canvas-light mb-[15px] rounded-[5px] overflow-hidden w-full">
            <div className="flex items-stretch">
              <button className="grow text-[14px] text-feed-text font-bold leading-[18px] py-[15px] px-[17px] cursor-pointer text-center flex items-center justify-center border-r-[1px] border-b-[1px] border-nav-border rounded-0 hover:bg-blue-50">
            ...
            <div className="m-[16px]">
              <div className="mb-[8px]">
                <div className="relative">
                  <textarea className="resize-none box-border scrollbar-hide overflow-x-hidden break-words h-[39px] py-[8px] pr-[68px] pl-[16px] border-[1px] border-nav-border rounded-[4px] w-full overflow-hidden outline-0 text-[14px] leading-[21px] active:border-input-focused focus:border-input-focused" maxLength="300" placeholder="Title" />
                  <div className="text-[10px] font-bold tracking-[0.5px] leading-[12px] pointer-events-none absolute bottom-[19px] right-[12px] text-feed-text">
                    0/300
                  </div>
                </div>
                <div>
                  <textarea className="outline-0 break-words rounded-[4px] border-[1px] border-nav-border w-full min-h-[122px] overflow-hidden py-[8px] px-[16px] resize-vertical text-[14px] leading-[21px] active:border-input-focused focus:border-input-focused" placeholder="Text (optional)" />
                </div>
              </div>
            </div>
