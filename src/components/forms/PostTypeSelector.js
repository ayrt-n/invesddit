...
function PostTypeSelector({ value, setPostType }) {
  ...
  return (
    <div className="flex items-stretch">
      <button name="postType" value="text" type="button" onClick={handleClick} className={`grow text-[14px] font-bold leading-[18px] py-[15px] px-[17px] cursor-pointer text-center flex items-center justify-center border-r-[1px] border-b-[1px] border-nav-border rounded-0 hover:bg-blue-50 ${value === "text" ? selectedClassNames : unselectedClassNames}`}>
      ...
      <button name="postType" value="media" type="button" onClick={handleClick} className={`grow text-[14px] font-bold leading-[18px] py-[15px] px-[17px] cursor-pointer text-center flex items-center justify-center border-r-[1px] border-b-[1px] border-nav-border rounded-0 hover:bg-blue-50 ${value === "media" ? selectedClassNames : unselectedClassNames}`}>
        <svg className="w-[20px] h-[20px] mr-[8px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <button name="postType" value="link" type="button" onClick={handleClick} className={`grow text-[14px] font-bold leading-[18px] py-[15px] px-[17px] cursor-pointer text-center flex items-center justify-center border-r-[1px] border-b-[1px] border-nav-border rounded-0 hover:bg-blue-50 ${value === "link" ? selectedClassNames : unselectedClassNames}`}>
        <svg className="w-[20px] h-[20px] mr-[8px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
