...
function TextInput({ showLength, ...props }) {
  ...
  return (
    <div className="relative">
      ...
      {showLength ?
        <div className="text-[10px] font-bold tracking-[0.5px] leading-[12px] pointer-events-none absolute bottom-[14px] right-[12px] text-feed-text" data-testid="showLength">
